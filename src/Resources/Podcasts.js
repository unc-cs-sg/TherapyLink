        ...
        <View style={resourcesStyles.resourceContainer}>
          <View style={resourcesStyles.resourceButtons}>
            <Button
              ...
              onPress={() =>
                Linking.openURL('https://www.therapyforblackgirls.com/podcast/')
              }
            />
          </View>
          <View style={resourcesStyles.resourceButtons}>
            <Button
              ...
              onPress={() => Linking.openURL('http://www.supersoul.tv/')}
            />
          </View>
          <View style={resourcesStyles.resourceButtons}>
            <Button
              ...
              title="Affirm"
              onPress={() =>
                Linking.openURL('https://www.redefineenough.com/affirmpodcast')
              }
            />
          </View>
          <View style={resourcesStyles.resourceButtons}>
            <Button
              ...
              onPress={() =>
                Linking.openURL('https://balancedblackgirl.libsyn.com/')
              }
            />
          </View>
        </View>
