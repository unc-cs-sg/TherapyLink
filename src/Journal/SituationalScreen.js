    ...
    render() {
        ...
        return (
            <View style={{ alignItems: 'center', }}>
                ...
                <TouchableOpacity onPress={() => { navigate('JournalSummary', { JournalEntry: navigation.getParam('JournalEntry', null), isPositive: true, emotionData: navigation.getParam('emotionData', []) }) }}>
